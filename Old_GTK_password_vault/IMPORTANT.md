...
In this repository, you may notice that there are two copies of the same code:

Updated_GTK_password_vault: Contains the latest updated version of the project with all recent improvements, bug fixes, and new features. This is the code you should use for current development or execution.
