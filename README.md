...
## ⬇️ Windows Download — No Installation Required

> **Just want to run it on Windows?** Download the portable build below — no MSYS2, no GTK, no setup needed.

[![Download Windows Build](https://img.shields.io/badge/Download-Windows%20Portable%20v4.0-blue?style=for-the-badge&logo=windows)](https://github.com/akashdey30/GTK-password-manager/releases/latest)

**Steps:**
1. Click the badge above → download `PasswordManager.zip` from Releases
2. Extract the zip anywhere
3. Double-click `PasswordManager.exe`
4. Windows SmartScreen may appear — click **More info → Run anyway** (unsigned build)

> Tested on Windows 10 and Windows 11. Includes all 62 required GTK3/OpenSSL/SQLite3 DLLs bundled inside the zip.

---

## Table of Contents

1. [Windows Download](#️-windows-download--no-installation-required)
...
6. [MVC vs SOLID: A Comparison](#mvc-vs-solid-a-comparison)
7. [Security](#security)
